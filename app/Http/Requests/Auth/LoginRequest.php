...
class LoginRequest extends FormRequest
{
    ...
    public function authenticate(): void
    {
        ...
        // Configure auth to use tenant connection if available
        $guard = 'web';
        if ($tenant) {
            $connectionName = "tenant_{$tenant->tenant_id}";
            
            // Temporarily configure auth provider to use tenant connection
    ...
    public function throttleKey(): string
    {
        ...
        return Str::transliterate(Str::lower($this->string('email')).'|'.$this->ip().'|'.$tenantId);
    }
}
