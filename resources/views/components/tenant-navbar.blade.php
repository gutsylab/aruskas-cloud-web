...
<nav class="navbar navbar-expand-lg navbar-light">
    <div class="container-fluid">
        ...
        <!-- Laravel Admin Brand -->
        <a class="navbar-brand d-flex align-items-center" href="{{ route('dashboard', ['tenant_id' => $tenant->tenant_id]) }}">
            <h5 class="mb-0 fw-semibold text-dark">{{ $tenant_name ?? config('app.name') }}</h5>
        </a>
