                ...
                <div class="d-inline-flex align-items-center gap-5">
                    ...
                    <div class="header-dropdown d-flex align-items-center">
                        <div class="dropdown pe-dropdown-mega pe-dropdown-hover">
                            <button class="btn pe-dropdown-button" type="button" data-bs-toggle="dropdown"
                                aria-expanded="false">
                                About
                            </button>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            ...
                                            <ul class="list-unstyled mb-0">
                                                ...
                                                <li><a class="dropdown-item" href="dashboard-ecommerce">Ecommerce</a>
                                                </li>
                                                <li><a class="dropdown-item" href="index">Academy</a></li>
                                                <li><a class="dropdown-item" href="dashboard-logistic">Logistics</a>
                                                </li>
                                                <li><a class="dropdown-item" href="dashboard-crm">CRM</a></li>
                                                <li><a class="dropdown-item" href="dashboard-project">Projects</a></li>
                                                <li><a class="dropdown-item" href="apps-invoice-detail">Invoices</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="col-lg-4">
                                            ...
                                            <ul class="list-unstyled mb-0">
                                                ...
                                                <li><a class="dropdown-item" href="../pages-search-result">Search
                                                        Results</a></li>
                                            </ul>
                                        </div>
                                        <div class="col-lg-4">
                                            ...
                                            <ul class="list-unstyled mb-0">
                                                ...
                                                <li><a class="dropdown-item" href="../auth-two-step-verify">Two Step
                                                        Verification</a></li>
                                                <li><a class="dropdown-item" href="../auth-reset-password">Reset
                                                        Password</a></li>
                                                <li><a class="dropdown-item" href="../auth-create-password">Create
                                                        Password</a></li>
                                                <li><a class="dropdown-item" href="../auth-404">404</a></li>
                                                <li><a class="dropdown-item"
                                                        href="../under-maintenance">Maintenance</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-4">
                                            ...
                                            <ul class="list-unstyled mb-0">
                                                ...
                                                <li><a class="dropdown-item" href="dashboard-crm">CRM</a></li>
                                                <li><a class="dropdown-item" href="dashboard-project">Projects</a>
                                                </li>
                                                <li><a class="dropdown-item" href="apps-invoice-detail">Invoices</a>
                                                </li>
                                            </ul>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <ul class="list-unstyled mb-0">
                                                <li><a class="dropdown-item" href="pages-profile">Profile</a></li>
                                                <li><a class="dropdown-item" href="../pages-timeline">Timeline</a>
                                                </li>
                                                <li><a class="dropdown-item" href="../pages-blog-list">Blogs</a></li>
                                                <li><a class="dropdown-item" href="../pages-pricing">Pricing</a></li>
                                                <li><a class="dropdown-item" href="../pages-gallery">Gallery</a></li>
            ...
            <div class="flex-shrink-0 d-flex align-items-center gap-1">
                ...
                <div class="dropdown pe-dropdown-mega d-none d-md-block">
                    ...
                    <div class="dropdown-menu dropdown-mega-md header-dropdown-menu pe-noti-dropdown-menu p-0">
                        ...
                        <div class="p-3">
                            <div class="noti-item">
                                <img src="{{ asset('assets/images/logo-md.png') }}" alt="Logo Image"
                                    class="avatar-md">
                                <div>
                            ...
                            <div class="noti-item">
                                ...
                                <div>
                                    ...
                                    <div class="p-2 bg-body-tertiary bg-opacity-50 rounded">
                                        <h6 class="mb-0 lh-base">Don’t forget! It’s Emily birthday tomorrow. Send them
                                            a message!</h6>
                                    </div>
                                </div>
                                <a href="javascript:void(0)"
                        ...
                        <div>
                            <div class="card">
                                    ...
                                    <li class="dropdown-item d-block py-2">
                                        <div class="d-flex items-start cart-dropdown-item">
                                            <img src="{{ asset('assets/images/product/img-01.png') }}"
                                                class="avatar-md me-3" alt="img">
                                            <div class="flex-grow-1">
                                                <div>
                                                    <h6><a href="apps-ecommerce-products-details"
                                                            class="text-reset">Branded Crop Top</a></h6>
                                                    <p class="mb-0 fs-12 text-muted">Quantity: <span>1 x $499</span>
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center px-2">
                                                <h6 class="m-0 fw-normal">$<span class="cart-item-price">499</span>
                                                </h6>
                                            </div>
                                        ...
                                        <div class="d-flex items-start cart-dropdown-item">
                                            ...
                                            <div class="flex-grow-1">
                                                <div>
                                                    ...
                                                    <p class="mb-0 fs-12 text-muted">Quantity: <span>2 x $159</span>
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center px-2">
                                        ...
                                        <div class="d-flex items-start cart-dropdown-item">
                                            ...
                                            <div class="flex-grow-1">
                                                <div>
                                                    ...
                                                    <p class="mb-0 fs-12 text-muted">Quantity: <span>6 x $399</span>
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center px-2">
                                                <h6 class="m-0 fw-normal">$<span class="cart-item-price">2394</span>
                                                </h6>
                                            </div>
                                            <div class="ps-2 d-flex">
                                                <button type="button" class="btn btn-sm"><i
                                        ...
                                        <div class="d-flex items-start cart-dropdown-item">
                                            ...
                                            <div class="flex-grow-1">
                                                <div>
                                                    ...
                                                    <p class="mb-0 fs-12 text-muted">Quantity: <span>3 x $259</span>
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center px-2">
                                    ...
                                    <li class="dropdown-item d-block py-2">
                                        <div class="d-flex items-start cart-dropdown-item">
                                            ...
                                            <div class="flex-grow-1">
                                                <div>
                                                    <h6><a href="apps-ecommerce-products-details"
                                                            class="text-reset">Mens T-shirt</a></h6>
                                                    <p class="mb-0 fs-12 text-muted">Quantity: <span>2 x $299</span>
                                                    </p>
                                                </div>
                                            </div>
                                            <div class="d-flex align-items-center px-2">
                                                <h6 class="m-0 fw-normal">$<span class="cart-item-price">598</span>
                                                </h6>
                                            </div>
                                            <div class="ps-2 d-flex">
                                                <button type="button" class="btn btn-sm"><i
                                ...
                                <div class="px-4 text-end">
                                    <a href="apps-ecommerce-cart"><button class="btn btn-outline-primary"
                                            type="button">View Cart</button></a>
                                    <a class="btn btn-primary view-checkout" href="apps-ecommerce-checkout">Checkout
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="dropdown pe-dropdown-mega d-none d-md-block">
                    <button class="btn btn-icon header-btn p-1" type="button" data-bs-toggle="dropdown"
                        ...
                        <img src="{{ asset('assets/images/flag/us.svg') }}" alt="Flag Image" height="16"
                            width="16" class="object-fit-cover rounded">
                    </button>
                    <ul class="dropdown-menu header-dropdown-menu">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center gap-2" href="javascript:void(0)">
                                <img src="{{ asset('assets/images/flag/es.svg') }}" alt="Flag Image" height="16"
                                    width="16" class="object-fit-cover rounded">
                                Spanish
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item d-flex align-items-center gap-2" href="javascript:void(0)">
                                <img src="{{ asset('assets/images/flag/ru.svg') }}" alt="Flag Image" height="16"
                                    width="16" class="object-fit-cover rounded">
                                French
                            </a>
                        </li>
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center gap-2" href="javascript:void(0)">
                                <img src="{{ asset('assets/images/flag/de.svg') }}" alt="Flag Image" height="16"
                                    width="16" class="object-fit-cover rounded">
                                German
                            </a>
                        </li>
                        <li>
                            <a class="dropdown-item d-flex align-items-center gap-2" href="javascript:void(0)">
                                <img src="{{ asset('assets/images/flag/cn.svg') }}" alt="Flag Image" height="16"
                                    width="16" class="object-fit-cover rounded">
                                Chinese
                            </a>
                        </li>
                    ...
                    <div class="dropdown-menu dropdown-mega-sm header-dropdown-menu p-3">
                        ...
                        <ul class="list-unstyled mb-1 border-bottom pb-1">
                            <li><a class="dropdown-item" href="javascript:void(0)"><i class="bi bi-clock me-1"></i>
                                    ChangLog</a></li>
                            <li><a class="dropdown-item" href="javascript:void(0)"><i class="bi bi-people me-1"></i>
                                    Team</a></li>
                            <li><a class="dropdown-item" href="javascript:void(0)"><i class="bi bi-headset me-1"></i>
                                    Support</a></li>
                        </ul>
                        <ul class="list-unstyled mb-0">
