...
@section('content')
    ...
    <div id="layout-wrapper">
        <div class="row">
            <div class="col-md-12">
                <form method="POST" id="form-create" class="form-horizontal" action="{{ route('cash-flows.store') }}"
                    ...
                    <div class="d-flex justify-content-end gap-3 my-5">
                        <a href="{{ route('cash-flows.index', ['tenant_id' => $tenant->tenant_id]) }}"
                            class="btn btn-light-light text-muted">Batalkan</a>
                        <button type="button" onclick="doSubmit()" class="btn btn-primary">Simpan Arus
                            Kas Baru</button>
                    </div>
                </form>
            </div>
